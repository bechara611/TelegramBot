...
//? comprobar que si sea fecha lo que coloques
        ...
        if(isNaN(dia)===true || isNaN(mes)===true || isNaN(year)===true){
         
            dia=null
            mes=null
            year=null;
            bot.sendMessage(msg.chat.id,`Tu fecha seleccionada es incorrecta, por favor, vuelva a escribir la fecha en forma de dd-mm-yyyy`)
            return
        }
