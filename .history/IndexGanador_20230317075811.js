...
try {
  let maquina = null;
const startEvento = bot.onText(/\/start/, (msg) => {
...
bot.on('message', (msg) => {
  if (msg.text === 'RH1' || msg.text === 'RH2' || msg.text === 'RH3' || msg.text === 'SML' || msg.text === 'KMEC 1' || msg.text === 'KMEC 2' || msg.text === 'EREMA 1' || msg.text === 'EREMA 2') {
    ...
    bot.removeListener(startEvento)
  }

})
bot.on('message', (msg) => {
  if (maquina) {
    bot.sendMessage(msg.chat.id, 'Por favor, escribe seguido de un espacio el dia, mes y año. Ejemplo: "16 3 2023"',);
  }else{
    bot.sendMessage(msg.chat.id, 'No es maq"',);
    return
  }
})
